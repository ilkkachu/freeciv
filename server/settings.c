...
static struct setting settings[] = {
  ...
  GEN_INT("globalwarming_percent", game.server.global_warming_percent,
           SSET_RULES, SSET_GEOLOGY, SSET_VITAL, SSET_SERVER_ONLY,
           N_("Global warming percent"),
           N_("This is a mutiplier for the rate of accumulation of global "
              "warming."), NULL, NULL, NULL, GAME_MIN_GLOBAL_WARMING_PERCENT,
  ...
  GEN_INT("nuclearwinter_percent", game.server.nuclear_winter_percent,
           ...
           N_("This is a mutiplier for the rate of accumulation of nuclear "
              "winter."), NULL, NULL, NULL, GAME_MIN_NUCLEAR_WINTER_PERCENT,
 ...
 GEN_INT("techlossrestore", game.server.techloss_restore,
  ...
  GEN_ENUM("trade_revenue_style", game.server.trade_revenue_style,
          SSET_RULES, SSET_ECONOMICS, SSET_RARE, SSET_TO_CLIENT,
